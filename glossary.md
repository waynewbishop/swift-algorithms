...
**[Best Case](https://en.wikipedia.org/wiki/Best,_worst_and_average_case)**
...
**[Comparable](https://en.wikipedia.org/wiki/Relational_operator)**
...
**[Edge](https://en.wikipedia.org/wiki/Glossary_of_graph_theory#edge)**
...
**[Equatable](https://en.wikipedia.org/wiki/Relational_operator)**
...
**[Exponential Time - O(2^n)](https://en.wikipedia.org/wiki/Time_complexity#Exponential_time)**
...
**[Frontier](https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm#Description)**
...
**[Growth Rate](https://en.wikipedia.org/wiki/Time_complexity#Table_of_common_time_complexities)**
...
**[Hashable](https://en.wikipedia.org/wiki/Hash_function)**
...
**[Height (Tree)](https://en.wikipedia.org/wiki/Tree_(data_structure)#Terminology)**
...
**[Linear Time - O(n)](https://en.wikipedia.org/wiki/Time_complexity#Linear_time)**
...
**[Linearithmic Time - O(n log n)](https://en.wikipedia.org/wiki/Time_complexity#Linearithmic_time)**
...
**[Logarithmic Time - O(log n)](https://en.wikipedia.org/wiki/Time_complexity#Logarithmic_time)**
...
**[Max Heap](https://en.wikipedia.org/wiki/Heap_(data_structure)#Comparison)**
...
**[Min Heap](https://en.wikipedia.org/wiki/Heap_(data_structure)#Comparison)**
...
**[Quadratic Time - O(n²)](https://en.wikipedia.org/wiki/Time_complexity#Quadratic_time)**
...
**[Reference Type](https://en.wikipedia.org/wiki/Reference_(computer_science))**
...
**[Value Type](https://en.wikipedia.org/wiki/Value_type_and_reference_type)**
...
**[Weight](https://en.wikipedia.org/wiki/Glossary_of_graph_theory#weighted_graph)**
